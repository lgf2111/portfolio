...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div className="w-4/5 p-6  border  rounded-lg shadow bg-green-200 border-green-100 card">
      <div className="h-52 w-52 mb-5 p-5 bg-gray-100 rounded-lg">
      ...
      <p className="mb-3 font-normal text-gray-700 h-32">{description}</p>
      <a
        href={link}
        target="_blank"
